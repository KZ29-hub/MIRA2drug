...
def top_3_retrieval(input_path, embedding_path, txt_path, model_path, ou_path):
    ...
    for example in test_json:
        text = f"""
        Try to figure out the relation of the drug {example["tcm1_name"]} and the drug {example["tcm2_name"]}.  
        The description of {example["tcm1_name"]} is {example["tcm1_desc"]}, the description of {example["tcm2_name"]} is {example["tcm2_desc"]}
        """
...
if __name__ == "__main__":
    root_path = "/root/autodl-tmp/dataset_ddi/tcm_cls2_tmp_n500/tcm_cls2_fold2/test.jsonl"
    ...
    ou_path = "/root/autodl-tmp/dataset_ddi/tcm_cls2_tmp_n500/tcm_cls2_fold2/test_add.jsonl"
