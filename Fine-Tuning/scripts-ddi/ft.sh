...
MAX_LENGTH=512
META_PATHS=(
/root/autodl-tmp/piccolo-embedding/meta_lists/piccolo-ft.txt
)

ROOT_DIRS=(
/root/autodl-tmp/dataset_ddi/piccolo_data/
)
# Hyper Parameter End 
...
train_args=(
    ...
    "--output_dir=formal/ddi2013/ddi2013_fold1_cls2_add1_stella_n85_epoch5_lr1e5_1019"
